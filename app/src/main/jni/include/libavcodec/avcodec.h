...
enum AVPacketSideDataType {
     ...
     * @code
     * u32le number of samples to skipFrame from start of this packet
     * u32le number of samples to skipFrame from end of this packet
     * u8    reason for start skipFrame
     * u8    reason for end   skipFrame (0=padding silence, 1=convergence)
     * @endcode
     */
...
#define FF_CODER_TYPE_DEFLATE   4
    ...
    /**
     * frame skipFrame comparison function
     * - encoding: Set by user.
     * - decoding: unused
     */
    int frame_skip_cmp;
...
#define FF_SUB_CHARENC_MODE_PRE_DECODER  1  ///< the AVPacket data needs to be recoded to UTF-8 before being fed to the decoder, requires iconv
    ...
    /**
     * Number of samples to skipFrame after a discontinuity
     * - decoding: unused
     * - encoding: set by libavcodec
     */
    int seek_preroll;
